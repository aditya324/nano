...
@section('title', 'Doctor Videos at Nano Hospitals')
@section('meta_description', 'Doctor videos at Nano Hospitals. We are proud to share insights from our doctors and their expertise across specialties.')
@section('meta_keywords', 'doctor videos, Nano Hospitals, doctor stories, doctor experiences')
...
@section('content')
    ...
    <div id="videoModal" class="fixed inset-0 bg-black/70 hidden flex items-center justify-center z-[9999] px-4">
        ...
        <div class="relative bg-black rounded-xl shadow-2xl w-full max-w-3xl" style="animation: scaleIn .25s ease-out">
            ...
            <div class="relative w-full aspect-video">
                <iframe id="videoIframe" referrerpolicy="strict-origin-when-cross-origin" class="absolute inset-0 w-full h-full rounded-xl" src="" frameborder="0"
    ...
    <section class="w-full py-16">
        <div class="container mx-auto px-4">
            ...
            <h1 class="text-center text-2xl font-semibold text-neutral-500 mb-14">
                All Doctor Videos
            </h1>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8" id="allDoctorVideos">
                    ...
                    <div class="relative">
                        ...
                        <div class="absolute inset-0 flex items-center justify-center">
                            <div class="w-14 h-14 bg-red-500 rounded-full flex items-center justify-center">
                                ...
                                <img src="./assets/logo/logo.png" class="absolute top-3 right-3 w-14" alt="">
                    </div>
                ...
                <div class="video-card bg-white rounded-xl shadow-md overflow-hidden cursor-pointer"
                    ...
                    <div class="p-4">
                        <h3 class="text-sm font-semibold text-[#737373]">
                            How To Prevent Cervical Cancer | Dr. Sanjana Kumar
                        </h3>
                    </div>
                </div>
            ...
            <div class="mt-12 flex flex-col items-center gap-4 text-center">
                <p class="text-base md:text-lg text-gray-700 font-medium">
                    For more doctor videos and health updates, please subscribe and follow our pages:
                </p>
