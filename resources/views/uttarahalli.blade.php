...
@section('title', 'Best Multispeciality Hospital in Uttarahalli | Nano Hospitals Uttarahalli')
@section('meta_description',
    'Nano Hospitals is one of the best multispeciality hospitals in Uttarahalli offering 24/7
    emergency care, maternity, orthopedic, and advanced medical services in Uttarahalli.')
@section('meta_keywords', 'multispeciality hospital, best hospital in Uttarahalli, best hospital in India')
...
@section('content')
    ...
    <section class="relative w-full h-[300px] sm:h-[360px] md:h-[420px] lg:h-[465px] overflow-hidden">
        ...
        <!-- Background Image -->
        <img src="./assets/uttarahalli.webp" alt="Nano Hospital Building"
...
">
            ...
            <div class="flex items-start gap-3 mb-2">
                ...
                <div>
                    ...
                    <p class="text-sm sm:text-base text-gray-500 leading-relaxed mt-1">
                        12/1A, Uttarahalli Main Rd, near Bharat Petrol Bunk,<br>
                        Simhadri layout, Uttarahalli Hobli, Bengaluru, <br>
                        Karnataka 560061
                    </p>
                </div>
            </div>
            ...
            <div class="flex items-center gap-3 mt-4">
                ...
                <a href="tel:+9108767200300" class="text-red-500 font-semibold text-base sm:text-lg">
                    +91 087672 00300
                </a>
            </div>
        ...
        <div class="container mx-auto px-4">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 items-center">
                ...
                <div>
                    ...
                    <a href="https://www.google.com/maps/dir/?api=1&destination=Nano+Hospitals+Uttarahalli+Bangalore"
                        target="_blank"
          ...
          hover:bg-red-600 transition">
                ...
                <div class="md:col-span-2 text-sm text-gray-600 leading-relaxed">
                    <p>
                        Nano Hospitals Uttarahalli is a trusted multispeciality hospital providing comprehensive healthcare
                        services with experienced specialists, advanced diagnostics, modern surgical facilities, and 24/7
                        emergency care. Conveniently located for patients from Uttarahalli, Banashankari, RR Nagar, Kengeri,
                        and Channasandra, we are committed to delivering affordable, patient-focused healthcare.
                    </p>

                    <!-- Hidden extra content -->
                    <p class="more-text hidden mt-2">
                        Our team of expert doctors provides diagnosis, treatment, surgery, rehabilitation, and preventive
                        healthcare using advanced medical technology and evidence-based practices.
                    </p>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="relative rounded-3xl overflow-hidden">
                                                <img src="./assets/hulimavu/vlcsnap-2026-01-06-13h39m07s921.webp"
                                                    alt="Patient Success Story" alt="Patient Success Story"
                            ...
                            <div class="space-y-4">
                                <div class="border border-gray-200 rounded-lg p-5 bg-white">
                                    <button
                                        ...
                                        Why is Nano Hospitals one of the best hospitals in Uttarahalli?
                                        <span class="text-red-600 text-xl shrink-0 ml-4">+</span>
                                    </button>
                                    <div class="faq-answer hidden mt-3 text-gray-600 leading-relaxed">
                                        Nano Hospitals Uttarahalli offers expert medical care with experienced doctors,
                                        advanced diagnostics, modern infrastructure, 24/7 emergency services, and
                                        compassionate patient care for families across South-West Bengaluru.
                                    </div>
                                </div>
                                <div class="border border-gray-200 rounded-lg p-5 bg-white">
                                    <button
                                        class="faq-question w-full flex justify-between items-center text-left font-medium text-gray-800">
                                        Which specialties are available at Nano Hospitals Uttarahalli?
                                        <span class="text-red-600 text-xl shrink-0 ml-4">+</span>
                                    </button>
                                    <div class="faq-answer hidden mt-3 text-gray-600 leading-relaxed">
                                        We provide expert treatment in Cardiology, Orthopedics, Neurology, Urology,
                                        Pediatrics, Gynecology, General Medicine, Gastroenterology, Pulmonology, Nephrology,
                                        ENT, Dermatology, and Physiotherapy. </div>
                                </div>
                                <div class="border border-gray-200 rounded-lg p-5 bg-white">
                                    <button
                                        class="faq-question w-full flex justify-between items-center text-left font-medium text-gray-800">
                                        Does Nano Hospitals Uttarahalli have emergency services?
                                        <span class="text-red-600 text-xl shrink-0 ml-4">+</span>
                                    </button>
                                    <div class="faq-answer hidden mt-3 text-gray-600 leading-relaxed">
                                        Yes. Our emergency department is available 24/7 with trained emergency physicians,
                                        ICU support, ambulance services, and advanced diagnostic facilities. </div>
                                </div>
                                <div class="border border-gray-200 rounded-lg p-5 bg-white">
                                    <button
                                        class="faq-question w-full flex justify-between items-center text-left font-medium text-gray-800">
                                        Where is Nano Hospitals Uttarahalli located?
                                        <span class="text-red-600 text-xl shrink-0 ml-4">+</span>
                                    </button>
                                    <div class="faq-answer hidden mt-3 text-gray-600 leading-relaxed">
                                        Nano Hospitals Uttarahalli is conveniently located for residents of Uttarahalli,
                                        Banashankari, RR Nagar, Kengeri, Channasandra, and surrounding neighborhoods. </div>
                                </div>
                                <div class="border border-gray-200 rounded-lg p-5 bg-white">
                                    <button
                                        class="faq-question w-full flex justify-between items-center text-left font-medium text-gray-800">
                                    ...
                                    <div class="faq-answer hidden mt-3 text-gray-600 leading-relaxed">
                                        Yes. We support cashless hospitalization through major insurance providers and
                                        government-approved health schemes, depending on policy terms. </div>
                                </div>
                                <div class="border border-gray-200 rounded-lg p-5 bg-white">
                                    <button
                                        class="faq-question w-full flex justify-between items-center text-left font-medium text-gray-800">
                                    ...
                                    <div class="faq-answer hidden mt-3 text-gray-600 leading-relaxed">
                                        Appointments can be booked online through our website, over the phone, or by
                                        visiting the hospital. Walk-in consultations are also available for selected
                                        specialties. </div>
                                </div>
                                ...
                                <div class="border border-gray-200 rounded-lg p-5 bg-white">
                                    ...
                                    <div class="faq-answer hidden mt-3 text-gray-600 leading-relaxed">
                                        We serve patients from Uttarahalli, Banashankari, RR Nagar, Channasandra, Kengeri,
                                        Kumaraswamy Layout, Padmanabhanagar, Subramanyapura, and nearby localities. </div>
                                </div>
                                ...
                                <div class="border border-gray-200 rounded-lg p-5 bg-white">
                                    <button
                                        class="faq-question w-full flex justify-between items-center text-left font-medium text-gray-800">
                                        Do you have experienced specialist doctors?
                                        <span class="text-red-600 text-xl shrink-0 ml-4">+</span>
                                    </button>
                                    <div class="faq-answer hidden mt-3 text-gray-600 leading-relaxed">
                                        Yes. Our multidisciplinary team includes experienced consultants across a wide range
                                        of medical and surgical specialties. </div>
                                </div>

                                <div class="border border-gray-200 rounded-lg p-5 bg-white">
                                    <button
                                        class="faq-question w-full flex justify-between items-center text-left font-medium text-gray-800">
                                        Are preventive health check-ups available?
                                        <span class="text-red-600 text-xl shrink-0 ml-4">+</span>
                                    </button>
                                    <div class="faq-answer hidden mt-3 text-gray-600 leading-relaxed">
                                        Yes. We offer comprehensive health screening packages designed for adults, senior
                                        citizens, women, men, and corporate wellness programs. </div>
                                </div>
                                ...
                                <div class="border border-gray-200 rounded-lg p-5 bg-white">
                                    ...
                                    <div class="faq-answer hidden mt-3 text-gray-600 leading-relaxed">
                                        Our hospital offers advanced diagnostic services, including laboratory testing, CT
                                        scans, MRI scans, ultrasound, ECG, X-ray, and other diagnostic investigations.
                                    </div>
                                </div>
                                ...
                                <div class="border border-gray-200 rounded-lg p-5 bg-white">
                                    <button
                                        class="faq-question w-full flex justify-between items-center text-left font-medium text-gray-800">
                                        Why should patients choose Nano Hospitals Uttarahalli?
                                        <span class="text-red-600 text-xl shrink-0 ml-4">+</span>
                                    </button>
                                    <div class="faq-answer hidden mt-3 text-gray-600 leading-relaxed">
                                        Patients trust Nano Hospitals for quality medical care, experienced specialists,
                                        advanced facilities, personalized treatment plans, and easy access from nearby
                                        residential areas. </div>
                                </div>
                                ...
                                <div class="border border-gray-200 rounded-lg p-5 bg-white">
                                    ...
                                    <div class="faq-answer hidden mt-3 text-gray-600 leading-relaxed">
                                        Yes. Our surgical teams perform a range of procedures, including orthopedic,
                                        general, urology, gynecology, laparoscopic, and gastrointestinal surgeries. </div>
                                </div>

                                <div class="border border-gray-200 rounded-lg p-5 bg-white">
                                    <button
                                        class="faq-question w-full flex justify-between items-center text-left font-medium text-gray-800">
                                        Is emergency ambulance support available?
                                        <span class="text-red-600 text-xl shrink-0 ml-4">+</span>
                                    </button>
                                    <div class="faq-answer hidden mt-3 text-gray-600 leading-relaxed">
                                        Yes. Emergency ambulance services are available to provide timely medical assistance
                                ...
                                <div class="border border-gray-200 rounded-lg p-5 bg-white">
                                    ...
                                    <div class="faq-answer hidden mt-3 text-gray-600 leading-relaxed">
                                        Yes. Parking facilities are available for patients and visitors. </div>
                                </div>
                                ...
                                <div class="border border-gray-200 rounded-lg p-5 bg-white">
                                    <button
                                        class="faq-question w-full flex justify-between items-center text-left font-medium text-gray-800">
                                        How can I reach Nano Hospitals Uttarahalli?
                                        <span class="text-red-600 text-xl shrink-0 ml-4">+</span>
                                    </button>
                                    <div class="faq-answer hidden mt-3 text-gray-600 leading-relaxed">
                                        Nano Hospitals Uttarahalli is easily accessible from Banashankari, RR Nagar,
                                        Kengeri, Kumaraswamy Layout, and surrounding areas by public transport and private
                                        vehicles. </div>
                                </div>
                            </div>
                    </section>
                            ...
                            <div class="bg-white rounded-2xl w-[380px] p-6 relative shadow-xl">
                                ...
                                <div class="flex justify-center gap-4">
                                    ...
                                    <a id="xShare" target="_blank"
                                        ...
                                        <svg class="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                                            <path
                                                d="M18.9 2H22l-7.4 8.5L23 22h-6.6l-5.2-6.5L5.7 22H2l7.9-9.1L1 2h6.8l4.7 5.9L18.9 2z" />
                                        </svg>
                                    </a>
