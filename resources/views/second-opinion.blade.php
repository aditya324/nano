...
@section('title', 'Expert Second Opinion Service | Nano Hospitals Bangalore')
@section('meta_description',
    'Get expert second opinions on demand from Nano Hospitals. Our second opinion service helps you confirm diagnosis, explore alternate treatments, and gain confidence before proceeding with care.')
@section('meta_keywords',
    'second opinion, expert opinion, medical opinion, medical consultation, medical advice')
...
@section('content')
    ...
    <section class="relative w-full min-h-[520px] bg-gray-100">
        ...
        <!-- Content Wrapper -->
        <div
            class="relative container mx-auto px-6 py-16 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-10">

            <!-- Left Text -->
            <div class="max-w-xl">
                <h1 class="text-3xl md:text-4xl font-semibold text-gray-800 leading-tight text-center">
            ...
            <div class="w-full max-w-sm bg-white rounded-xl shadow-xl p-6">
                ...
                <x-contact-form source="second-opinion" />
            </div>
            ...
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                ...
                <div class="flex-1 md:pl-10">
                    <p class="text-gray-500 text-sm md:text-base leading-relaxed">
                        Prioritising your health means understanding all aspects of the condition and proposed treatment
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-14 items-start">
                ...
                <div class="relative">
                    <div class="rounded-3xl overflow-hidden shadow-lg">
                        <img src="./assets/consultation.png" alt="Second Opinion Consultation"
        ...
        <div class="container mx-auto px-6">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
                ...
                <div class="space-y-2">
                    ...
                    <details class="group rounded-xl transition bg-gray-50 hover:bg-gray-100">
                        <summary
                            class="flex items-center justify-between cursor-pointer px-6 py-4 text-gray-600 font-medium">
