...
class ManagementofPulmonaryHypertensionMedicationsInterventionsConditionSeeder extends Seeder
{
    public function run(): void
    {
        Condition::updateOrCreate(
            ...
            ['value' => 'Long-term pulmonology and cardiology follow-up care'],
                ...
                'recovery' => 'The long-term outlook following pulmonary hypertension management depends on the underlying cause, severity of disease, response to therapy, and overall cardiopulmonary health. Early treatment, medication adherence, pulmonary rehabilitation, healthy lifestyle habits, oxygen support, smoking cessation, and continuous specialist follow-up significantly help improve symptom control, slow disease progression, reduce complications, preserve heart and lung function, and enhance overall quality of life. ___________________ 15. Anti-Fibrotic Therapy (Pulmonary Fibrosis) Anti-Fibrotic Therapy (Pulmonary Fibrosis) Procedures',
                'sort_order' => 15,
                'is_active' => true,
                'meta_title' => 'Management of Pulmonary Hypertension (Medications / Interventions)',
                'meta_description' => 'Management of pulmonary hypertension involves specialized medical and interventional procedures used to reduce high blood pressure within the pulmonary arteries',
                'meta_keywords' => '',
            ]
        );
    }
