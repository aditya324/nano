...
class LocalRegionalFreeFlapReconstructionConditionSeeder extends Seeder
{
    public function run(): void
    {
        Condition::updateOrCreate(
            ['slug' => Str::slug('Local / Regional / Free Flap Reconstruction')],
            [
                'name' => 'Local / Regional / Free Flap Reconstruction',
                'slug' => Str::slug('Local / Regional / Free Flap Reconstruction'),
                'h1' => 'Local / Regional / Free Flap Reconstruction',
                'icon' => null,
                'cta_text' => null,
                'cta_link' => null,
            ...
            ['value' => 'Long-term reconstructive follow-up and scar management care'],
                ...
                'recovery' => 'The long-term outlook for flap reconstruction procedures depends on the severity of tissue loss, blood supply to the reconstructed area, and postoperative rehabilitation. Early reconstructive intervention, skilled microsurgical care, infection control, nutritional support, and regular follow-up significantly improve healing, function, and cosmetic outcomes. Continuous rehabilitation and multidisciplinary care are important for maintaining long-term recovery and quality of life.',
                'sort_order' => 3,
                'is_active' => true,
                'meta_title' => 'Local / Regional / Free Flap Reconstruction',
