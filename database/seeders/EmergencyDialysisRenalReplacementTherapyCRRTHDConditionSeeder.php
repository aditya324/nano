...
class EmergencyDialysisRenalReplacementTherapyCRRTHDConditionSeeder extends Seeder
{
    public function run(): void
    {
        Condition::updateOrCreate(
            ...
            ['value' => 'Long-term nephrology follow-up and renal care planning when required'],
                ...
                'recovery' => 'The long-term outlook following emergency dialysis or renal replacement therapy depends on the underlying kidney condition, severity of critical illness, response to treatment, and overall patient health. Early intervention, effective critical care management, medication adherence, nutritional support, rehabilitation, and regular nephrology follow-up significantly help improve kidney recovery, reduce complications, support organ function, and enhance overall quality of life. ____________________ 8. Sepsis Management (Early Antibiotics, Source Control) Sepsis Management (Early Antibiotics, Source Control) Procedures',
                'sort_order' => 8,
                'is_active' => true,
                'meta_title' => 'Emergency Dialysis / Renal Replacement Therapy (CRRT / HD)',
                'meta_description' => 'Emergency dialysis and renal replacement therapy are advanced medical procedures used to support kidney function in critically ill patients whose kidneys are un',
                'meta_keywords' => '',
            ]
        );
    }
