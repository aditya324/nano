...
class BreastReconstructionPostMastectomyAestheticConditionSeeder extends Seeder
{
    public function run(): void
    {
        Condition::updateOrCreate(
            ['slug' => Str::slug('Breast Reconstruction (Post-Mastectomy & Aesthetic)')],
            [
                'name' => 'Breast Reconstruction (Post-Mastectomy & Aesthetic)',
                'slug' => Str::slug('Breast Reconstruction (Post-Mastectomy & Aesthetic)'),
                'h1' => 'Breast Reconstruction (Post-Mastectomy & Aesthetic)',
                'icon' => null,
                'cta_text' => null,
                'cta_link' => null,
            ...
            ['value' => 'Long-term postoperative care, physiotherapy, and emotional support services'],
                ...
                'sort_order' => 8,
                'is_active' => true,
                'meta_title' => 'Breast Reconstruction (Post-Mastectomy & Aesthetic)',
