...
class BurnManagementFluidResuscitationWoundCareInfectionControlConditionSeeder extends Seeder
{
    public function run(): void
    {
        Condition::updateOrCreate(
            ...
            [
                'name' => 'Burn Management (Fluid Resuscitation, Wound Care, Infection Control)',
                'slug' => Str::slug('Burn Management (Fluid Resuscitation, Wound Care, Infection Control)'),
                'h1' => 'Burn Management (Fluid Resuscitation, Wound Care, Infection Control)',
                'icon' => null,
                'cta_text' => null,
                'cta_link' => null,
