...
class TMJArthroscopyInstrumentsConditionSeeder extends Seeder
{
    public function run(): void
    {
        Condition::updateOrCreate(
            ...
            ['value' => 'Regular follow-up evaluation for long-term joint function assessment'],
                ...
                'recovery' => 'The long-term outlook with advanced TMJ arthroscopy instruments is highly positive because minimally invasive arthroscopic techniques significantly improve surgical precision, reduce postoperative discomfort, shorten recovery time, and enhance long-term jaw function. Continuous advancements in endoscopic visualization, micro-instrumentation, and minimally invasive technology continue to improve patient outcomes and TMJ surgical care. __________________',
                'sort_order' => 6,
                'is_active' => true,
                'meta_title' => 'TMJ Arthroscopy Instruments',
                'meta_description' => 'TMJ arthroscopy instruments are specialized surgical tools and visualization systems used in minimally invasive temporomandibular joint (TMJ) procedures to diag',
                'meta_keywords' => '',
            ]
        );
    }
