...
class LaserEquipmentConditionSeeder extends Seeder
{
    public function run(): void
    {
        Condition::updateOrCreate(
            ['slug' => Str::slug('Laser Equipment')],
            [
            ...
            ['value' => 'Follow-up treatments and skincare maintenance when required'],
                ...
                'recovery' => 'The long-term outlook with advanced laser equipment is highly positive because modern laser and light-based technologies provide effective, minimally invasive treatment for cosmetic, reconstructive, and dermatologic conditions. Continuous advancements in laser precision, safety systems, and skin rejuvenation techniques significantly improve treatment outcomes, recovery time, and long-term skin health. __________________________ 165. Negative Pressure Wound Therapy (VAC) Negative Pressure Wound Therapy (VAC) Equipment',
                'sort_order' => 4,
                'is_active' => true,
                'meta_title' => 'Laser Equipment',
                'meta_description' => 'Laser equipment such as CO2 lasers, fractional lasers, and IPL (Intense Pulsed Light) systems are advanced medical and aesthetic technologies used for skin resu',
                'meta_keywords' => '',
            ]
        );
    }
