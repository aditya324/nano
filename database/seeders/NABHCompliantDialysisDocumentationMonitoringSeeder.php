...
class NABHCompliantDialysisDocumentationMonitoringSeeder extends Seeder
{
    public function run(): void
    {
        $procedure = Procedure::updateOrCreate(
            ...
            [
                'title' => 'NABH-Compliant Dialysis Documentation & Monitoring',
                'slug' => Str::slug('NABH-Compliant Dialysis Documentation & Monitoring'),
                'introduction' => 'NABH-Compliant Dialysis Documentation and Monitoring is a structured nephrology quality-management system designed to maintain accurate patient records, dialysis safety standards, treatment monitoring, and regulatory compliance. This system ensures high-quality dialysis care through standardized protocols, continuous patient monitoring, infection surveillance, and proper medical documentation. NABH compliance improves patient safety, treatment transparency, and healthcare quality assurance.',
                'what_is' => 'The documentation and monitoring system includes: Dialysis treatment records Patient vital monitoring Dialysis adequacy tracking Infection surveillance reports Medication records Water quality documentation Equipment maintenance logs Emergency event reporting Healthcare teams maintain detailed records regarding: Blood pressure during dialysis Fluid removal Dialysis duration Vascular access status Laboratory investigations Adverse reactions Infection-control measures The system supports: Quality improvement programs Patient safety audits Regulatory compliance Standardized nephrology care Long-term dialysis monitoring Regular audits and staff training help maintain NABH standards consistently.',
                'symptoms' => [
            ...
            ['value' => 'Reduced treatment quality without proper compliance'],
                ...
                'long_term_outlook' => 'NABH-compliant dialysis documentation and monitoring systems improve treatment safety, quality assurance, and long-term renal patient management. Standardized monitoring supports better clinical outcomes, reduced complications, and safer long-term dialysis care.',
                'conclusion' => '',
                'seo_title' => 'NABH-Compliant Dialysis Documentation & Monitoring',
                'seo_description' => 'NABH-Compliant Dialysis Documentation and Monitoring is a structured nephrology quality-management system designed to maintain accurate patient records, dialysis safety standards, treatment monitoring, and regulatory compliance. This system ensures high-quality dialysis care through standardized protocols, continuous patient monitoring, infection surveillance, and proper medical documentation. NABH compliance improves patient safety, treatment transparency, and healthcare quality assurance.',
                'seo_keywords' => '',
                'is_active' => true,
            ]
        );
