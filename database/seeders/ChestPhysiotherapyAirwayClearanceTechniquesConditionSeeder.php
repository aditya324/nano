...
class ChestPhysiotherapyAirwayClearanceTechniquesConditionSeeder extends Seeder
{
    public function run(): void
    {
        Condition::updateOrCreate(
            ...
            ['value' => 'Long-term pulmonary rehabilitation and respiratory follow-up when required'],
                ...
                'recovery' => 'The long-term outlook following chest physiotherapy and airway clearance therapy is generally positive when patients actively participate in regular respiratory care and rehabilitation. Early intervention, consistent airway clearance, pulmonary rehabilitation, medication adherence, healthy lifestyle habits, smoking cessation, and regular pulmonology follow-up significantly help improve breathing function, reduce respiratory infections, prevent mucus buildup, preserve lung health, and enhance overall quality of life. _____________________ 22. VATS (Video-Assisted Thoracoscopic Surgery) VATS (Video-Assisted Thoracoscopic Surgery) Procedures',
                'sort_order' => 22,
                'is_active' => true,
                'meta_title' => 'Chest Physiotherapy / Airway Clearance Techniques',
                'meta_description' => 'Chest physiotherapy and airway clearance techniques are specialized respiratory therapy procedures used to help remove mucus and secretions from the lungs and a',
                'meta_keywords' => '',
            ]
        );
    }
