...
class AntiFibroticTherapyPulmonaryFibrosisConditionSeeder extends Seeder
{
    public function run(): void
    {
        Condition::updateOrCreate(
            ...
            ['value' => 'Long-term pulmonology follow-up and supportive respiratory care'],
                ...
                'recovery' => 'The long-term outlook following anti-fibrotic therapy depends on the severity of pulmonary fibrosis, speed of disease progression, response to treatment, and overall respiratory health. Early diagnosis, consistent medication use, pulmonary rehabilitation, healthy lifestyle habits, smoking cessation, oxygen support when required, and regular specialist follow-up significantly help slow disease progression, preserve lung function, reduce complications, improve physical endurance, and enhance overall quality of life. _________________ 16. Smoking Cessation Programs & Counseling Smoking Cessation Programs & Counseling Procedures',
                'sort_order' => 16,
                'is_active' => true,
                'meta_title' => 'Anti-Fibrotic Therapy (Pulmonary Fibrosis)',
                'meta_description' => 'Anti-fibrotic therapy is a specialized respiratory treatment procedure used to slow the progression of pulmonary fibrosis and other chronic fibrotic lung diseas',
                'meta_keywords' => '',
            ]
        );
    }
