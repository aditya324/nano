...
class SpeechSwallowingTherapyPostStrokeNeurologicalDisordersConditionSeeder extends Seeder
{
    public function run(): void
    {
        Condition::updateOrCreate(
            ['slug' => Str::slug('Speech & Swallowing Therapy (Post-Stroke / Neurological Disorders)')],
            [
                'name' => 'Speech & Swallowing Therapy (Post-Stroke / Neurological Disorders)',
                'slug' => Str::slug('Speech & Swallowing Therapy (Post-Stroke / Neurological Disorders)'),
                'h1' => 'Speech & Swallowing Therapy (Post-Stroke / Neurological Disorders)',
                'icon' => null,
                'cta_text' => null,
                'cta_link' => null,
