...
class SkinGraftingSplitThicknessFullThicknessConditionSeeder extends Seeder
{
    public function run(): void
    {
        Condition::updateOrCreate(
            ['slug' => Str::slug('Skin Grafting (Split-Thickness & Full-Thickness)')],
            [
                'name' => 'Skin Grafting (Split-Thickness & Full-Thickness)',
                'slug' => Str::slug('Skin Grafting (Split-Thickness & Full-Thickness)'),
                'h1' => 'Skin Grafting (Split-Thickness & Full-Thickness)',
                'icon' => null,
                'cta_text' => null,
                'cta_link' => null,
