...
class NegativePressureWoundTherapyVACSeeder extends Seeder
{
    public function run(): void
    {
        $procedure = Procedure::updateOrCreate(
            ...
            ['value' => 'Skin irritation or leakage around dressing seal areas'],
                ...
                'conclusion' => '',
                'seo_title' => 'Negative Pressure Wound Therapy (VAC)',
                'seo_description' => 'Negative Pressure Wound Therapy (NPWT), commonly known as VAC (Vacuum-Assisted Closure) therapy, is an advanced wound management system used to promote healing in complex, chronic, traumatic, surgical, and non-healing wounds. The system uses controlled negative pressure to remove excess fluid, reduce infection risk, improve blood circulation, and stimulate healthy tissue growth.',
                'seo_keywords' => '',
                'is_active' => true,
            ]
        );
