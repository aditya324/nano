...
class PhysiotherapyEquipmentTreadmillsWeightsExerciseBandsSeeder extends Seeder
{
    public function run(): void
    {
        $procedure = Procedure::updateOrCreate(
            ['slug' => Str::slug('Physiotherapy Equipment (Treadmills, Weights & Exercise Bands)')],
            [
                'title' => 'Physiotherapy Equipment (Treadmills, Weights & Exercise Bands)',
                'slug' => Str::slug('Physiotherapy Equipment (Treadmills, Weights & Exercise Bands)'),
                'introduction' => 'Physiotherapy equipment includes specialized rehabilitation tools and exercise devices used to improve strength, mobility, balance, endurance, coordination, and overall physical function. These tools support recovery from injuries, surgeries, neurological disorders, musculoskeletal conditions, and chronic mobility limitations.',
                'what_is' => 'Common physiotherapy equipment includes treadmills for gait and endurance training, weights for muscle strengthening, and exercise bands for resistance and flexibility exercises. Additional rehabilitation tools may include balance boards, therapy balls, parallel bars, stationary cycles, pulley systems, and mobility aids. Physiotherapy equipment is widely used in rehabilitation centers, hospitals, sports medicine clinics, and fitness-based recovery programs under professional supervision.',
                'symptoms' => [
            ...
            ['value' => 'Physiotherapy equipment is used in rehabilitation programs for strengthening exercises, gait training, flexibility improvement, endurance conditioning, balance rehabilitation, posture correction, and functional mobility training. Rehabilitation specialists customize exercise programs using appropriate equipment to support safe recovery, improve physical performance, and restore independence.'],
                ...
                'long_term_outlook' => 'The long-term outlook with physiotherapy equipment-based rehabilitation is generally very positive when exercises are performed consistently and safely. Rehabilitation equipment helps improve strength, flexibility, balance, endurance, and functional independence while supporting long-term physical health and recovery. Continuous exercise, rehabilitation follow-up, and healthy lifestyle practices are important for maintaining long-term mobility and overall well-being.',
                'conclusion' => '',
                'seo_title' => 'Physiotherapy Equipment (Treadmills, Weights & Exercise Bands)',
                'seo_description' => 'Physiotherapy equipment includes specialized rehabilitation tools and exercise devices used to improve strength, mobility, balance, endurance, coordination, and overall physical function. These tools support recovery from injuries, surgeries, neurological disorders, musculoskeletal conditions, and chronic mobility limitations.',
                'seo_keywords' => '',
                'is_active' => true,
            ]
        );
