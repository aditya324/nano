...
class ManagementofOralSubmucousFibrosisConditionSeeder extends Seeder
{
    public function run(): void
    {
        Condition::updateOrCreate(
            ['slug' => Str::slug('Management of Oral Submucous Fibrosis')],
            [
                'name' => 'Management of Oral Submucous Fibrosis',
                'slug' => Str::slug('Management of Oral Submucous Fibrosis'),
                'h1' => 'Management of Oral Submucous Fibrosis',
                'icon' => null,
                'cta_text' => null,
                'cta_link' => null,
            ...
            ['value' => 'Reconstruction using skin grafts, buccal fat pad grafts, or flap procedures with long-term rehabilitation support'],
                ...
                'recovery' => 'The long-term outlook for management of oral submucous fibrosis depends on the severity of fibrosis, timing of treatment, and complete discontinuation of harmful chewing habits. Surgical release combined with grafting procedures, physiotherapy, nutritional care, and regular follow-up significantly improves mouth opening, oral function, and quality of life. Continuous monitoring is important due to the increased long-term risk of oral cancer development. ________________________ 20. Pediatric Maxillofacial Surgery Pediatric Maxillofacial Surgery Procedures',
                'sort_order' => 22,
                'is_active' => true,
                'meta_title' => 'Management of Oral Submucous Fibrosis',
