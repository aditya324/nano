...
class GaitTrainingDevicesConditionSeeder extends Seeder
{
    public function run(): void
    {
        Condition::updateOrCreate(
            ...
            ['value' => 'Attending regular rehabilitation and mobility assessment sessions'],
                ...
                'recovery' => 'The long-term outlook with gait training rehabilitation is generally very positive when therapy is started early and practiced consistently. Gait training devices can significantly improve walking ability, balance, coordination, endurance, and independence. Ongoing rehabilitation, physical activity, and regular follow-up are important for maintaining long-term mobility and reducing fall risk. _____________________ 136. Pulmonary Rehabilitation Tools Pulmonary Rehabilitation Tools Equipment',
                'sort_order' => 6,
                'is_active' => true,
                'meta_title' => 'Gait Training Devices',
                'meta_description' => 'Gait training devices are specialized rehabilitation tools used to improve walking ability, balance, coordination, posture, and mobility in individuals with mov',
                'meta_keywords' => '',
            ]
        );
    }
