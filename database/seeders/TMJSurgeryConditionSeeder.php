...
class TMJSurgeryConditionSeeder extends Seeder
{
    public function run(): void
    {
        Condition::updateOrCreate(
            ['slug' => Str::slug('TMJ Surgery')],
            [
                'name' => 'TMJ Surgery',
                'slug' => Str::slug('TMJ Surgery'),
                'h1' => 'TMJ Surgery',
            ...
            ['value' => 'Long-term physiotherapy, bite management, and postoperative rehabilitation support'],
                ...
                'recovery' => 'The long-term outlook for TMJ surgery is generally very positive because modern minimally invasive and reconstructive techniques significantly improve jaw movement, pain relief, chewing function, and overall quality of life. Early treatment, physiotherapy, lifestyle modification, regular follow-up, and rehabilitation exercises are important for maintaining successful long-term joint function and reducing recurrence of symptoms. ________________________ 9. Reconstruction with Local / Regional / Free Flaps Reconstruction with Local / Regional / Free Flaps Procedures',
                'sort_order' => 9,
                'is_active' => true,
                'meta_title' => 'TMJ Surgery',
