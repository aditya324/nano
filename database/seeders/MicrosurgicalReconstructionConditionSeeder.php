...
class MicrosurgicalReconstructionConditionSeeder extends Seeder
{
    public function run(): void
    {
        Condition::updateOrCreate(
            ['slug' => Str::slug('Microsurgical Reconstruction')],
            [
                'name' => 'Microsurgical Reconstruction',
                'slug' => Str::slug('Microsurgical Reconstruction'),
                'h1' => 'Microsurgical Reconstruction',
                'icon' => null,
                'cta_text' => null,
                'cta_link' => null,
            ...
            ['value' => 'Long-term physiotherapy, rehabilitation, and reconstructive follow-up care'],
                ...
                'sort_order' => 7,
                'is_active' => true,
                'meta_title' => 'Microsurgical Reconstruction',
