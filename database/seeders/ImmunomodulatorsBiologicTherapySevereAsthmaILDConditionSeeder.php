...
class ImmunomodulatorsBiologicTherapySevereAsthmaILDConditionSeeder extends Seeder
{
    public function run(): void
    {
        Condition::updateOrCreate(
            ...
            ['value' => 'Long-term pulmonology follow-up and respiratory rehabilitation support'],
                ...
                'recovery' => 'The long-term outlook following immunomodulator or biologic therapy depends on the severity of the underlying lung disease, response to treatment, overall immune status, and adherence to long-term respiratory care. Early intervention, consistent treatment, pulmonary rehabilitation, healthy lifestyle habits, infection prevention, and regular specialist follow-up significantly help improve symptom control, reduce disease progression, prevent exacerbations, preserve lung function, and enhance overall quality of life. ____________________ 8. Bronchoscopy (Diagnostic & Therapeutic) Bronchoscopy (Diagnostic & Therapeutic) Procedures',
                'sort_order' => 8,
                'is_active' => true,
                'meta_title' => 'Immunomodulators / Biologic Therapy (Severe Asthma, ILD)',
                'meta_description' => 'Immunomodulators and biologic therapy are advanced respiratory treatment procedures used to manage severe asthma, interstitial lung disease (ILD), and other chr',
                'meta_keywords' => '',
            ]
        );
    }
