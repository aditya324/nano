...
class DentalSurgicalChairswithImagingSeeder extends Seeder
{
    public function run(): void
    {
        $procedure = Procedure::updateOrCreate(
            ...
            ['value' => 'Need for trained personnel to operate advanced chairside technologies'],
                ...
                'long_term_outlook' => 'The long-term outlook for dental and surgical chairs with integrated imaging is highly positive because advanced digital technologies significantly improve clinical efficiency, patient comfort, diagnostic precision, and surgical outcomes. Continuous advancements in chair ergonomics, AI-assisted imaging, IoT connectivity, and digital dentistry systems continue to enhance patient care, workflow integration, and long-term healthcare delivery.',
                'conclusion' => '',
                'seo_title' => 'Dental / Surgical Chairs with Imaging',
                'seo_description' => 'Dental and surgical chairs with integrated imaging are advanced treatment units designed to support dental, oral, and maxillofacial procedures by combining patient positioning systems with diagnostic imaging and digital visualization technologies. These systems improve surgical precision, workflow efficiency, patient comfort, and real-time clinical assessment during procedures.',
                'seo_keywords' => '',
                'is_active' => true,
            ]
        );
