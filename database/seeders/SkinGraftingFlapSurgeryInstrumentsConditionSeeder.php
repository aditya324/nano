...
class SkinGraftingFlapSurgeryInstrumentsConditionSeeder extends Seeder
{
    public function run(): void
    {
        Condition::updateOrCreate(
            ...
            ['value' => 'Long-term scar management and follow-up care support'],
                ...
                'recovery' => 'The long-term outlook with advanced skin grafting and flap surgery instruments is highly positive because these specialized tools improve surgical precision, graft survival, wound healing, and reconstructive outcomes. Continuous advancements in reconstructive surgical technology and microsurgical techniques significantly improve patient recovery, functional restoration, and long-term cosmetic results. ____________________ 164. Laser Equipment (CO2, Fractional, IPL) Laser Equipment (CO2, Fractional & IPL) Equipment',
                'sort_order' => 3,
                'is_active' => true,
                'meta_title' => 'Skin Grafting / Flap Surgery Instruments',
                'meta_description' => 'Skin grafting and flap surgery instruments are specialized surgical tools and equipment used in reconstructive procedures to repair skin loss, soft tissue defec',
                'meta_keywords' => '',
            ]
        );
    }
